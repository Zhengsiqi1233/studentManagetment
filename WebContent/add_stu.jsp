...
<body>
   ...
   <div class="main">
   		...
   		<form method="post" action="add.do">
   			<span>学员学号：</span> <input type="text" name="sno"/><br />
   			<span>姓名：</span> <input type="text" name="sname"/><br />
   			<span>性别：</span> <input type="text" name="sex"/><br />
   			<span>班级名称：</span> <input type="text"  name="cname"/><br />
   			<span>专业名称：</span> <input type="text" name="sdept"/><br />
   			<span>学校名称：</span> <input type="text" name="ssname"/><br />
   			<span>邮箱：</span> <input type="text" name="smail"/><br />
   			<span>手机号：</span> <input type="text" name="sphone"/><br />
